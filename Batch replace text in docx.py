...
def batch_text_replace_doxc(original_content="than current",
       ...
       path="C:\SW document\ETCO2 Test\ETCO2 Shawn(Yan)1.1/",
       new_path="C:\SW document\ETCO2 Test\ETCO2 Shawn(Yan)1.1/" + 'V1.2test/'):
    ...
    for item in file_list:
        ...
        for table in document.tables:
            for cell in table._cells:
                ...
                #         paragraph.style.font.size = 130000 # font size = 10
                ...
                if original_content in cell.text:
                    print cell.text
                    cell.text = cell.text.replace(original_content, insert_content)
